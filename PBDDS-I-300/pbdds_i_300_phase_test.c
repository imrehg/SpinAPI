/*
 * This example program tests the phase switching capability of the PulseBlaster DDS 300.  This program will produce
 * a 1MHz signal on the oscilloscope that is on for 8 microseconds, cycling through four pahse offsets. It will
 * turn off for 1 milisecond, and will then repeat this pattern indefinately.
 *
...
int main(int argc, char **argv)
{
	...
	// Program the first 3 frequency registers, there are 16 available for the PBDDS-1-300
	...
	// Program the first 5 phase registers, there are 16 available for the PBDDS-1-300
	...
	start =
    pb_inst_dds(1, 1, TX_ENABLE, NO_PHASE_RESET, 0x1FF, CONTINUE, 0, 2.0*us);
